...
class AggiuntaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Prodotto::create([
            'nome_prodotto'       => $validated['nome_prodotto'], // Nome del prodotto
            'data_scadenza'       => $data_scadenza, // Data di scadenza calcolata
            'id_categoria_durata' => $categoriaDurataId, // ID della tabella pivot
            'created_at'          => now(),
            'updated_at'          => now()
        ]);
